from sqlalchemy import Column, String, Text, TIMESTAMP, BigInteger, Float, CHAR, ForeignKey, Boolean, text
...
class Car(Base):
    ...
    # NEW FIELD — required for blacklist feature
    is_blacklisted = Column(Boolean, server_default=text("false"), nullable=False)
